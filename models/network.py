...
class ResUnet_illum_tran_ds3_add_conv5_sSE_cSE_up49_origin1(nn.Module):
...
class ResUnet_illum_tran_ds3_add_conv5_sSE_cSE_up49_8(nn.Module):
...
class ResUnet_illum_tran_ds3_add_conv5_sSE_cSE_up49_8_(nn.Module):
    ...
    def __init__(self, resnet='resnet34', num_classes=2):
        ...
        self.up3 = UnetBlock_tran10_bn(128, 64)
        self.up4 = UnetBlock_tran10_bn(64, 64)
        self.ec_block = expand_compress_block3_(8)
        self.up5_2 = nn.Conv2d(32, self.num_classes, kernel_size=1, padding=0)
...
class ResUnet_illum_tran_ds3_add_conv5_sSE_cSE_up49_woillum_8(nn.Module):
...
class ResUnet_illum_tran_ds3_add_conv5_sSE_cSE_up49_weight(nn.Module):
    ...
    def __init__(self, resnet='resnet34', num_classes=2):
        ...
        self.out1 = output_block2_weight(64)
        self.out2 = output_block2_weight(64)
        self.out3 = output_block2_weight(64)
        self.out4 = output_block2_weight(64)
...
class ResUnet_illum_tran_ds3_add_conv5_sSE_cSE_up49_weight2(nn.Module):
...
class ResUnet_illum_tran_ds3_add_conv5_sSE_cSE_up49_weight2_wods(nn.Module):
...
class ResUnet_illum_tran_ds3_add_conv5_sSE_cSE_up49_3(nn.Module):
