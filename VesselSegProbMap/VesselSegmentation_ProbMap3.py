...
#    downsizeRatio = 1000./np.maximum(Img0.shape[0], Img0.shape[1])
    ImgResized = Img0
    ImgResized = cv2.resize(ImgResized, fx=0.6, fy=0.6, dsize = None)
...
#        plt.show()
        ...
        VesselProbImg1 = cv2.resize(VesselProbImg1, fx=0.6, fy=0.6, dsize = None)
        VesselProbImg2 = cv2.resize(VesselProbImg2, fx=0.6, fy=0.6, dsize = None)
