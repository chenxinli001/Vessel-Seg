...
def modelEvalution(i,net,savePath,loss_all):
    ...
    ArteryAUC,ArteryAcc,ArterySp,ArterySe,VeinAUC,VeinAcc,VeinSp,VeinSe = Evalution_AV(ArteryPredAll,VeinPredAll,VesselPredAll,LabelArteryAll,LabelVeinAll,LabelVesselAll,MaskAll)
...
def Evalution_AV(PredAll1,PredAll2,VesselPredAll,LabelAll1,LabelAll2, LabelVesselAll,MaskAll):
    threshold_confusion = 0.5
    ...
    accuracy1,specificity1,sensitivity1 = AVclassifiationMetrics(PredAll1,PredAll2,VesselPredAll,LabelAll1,LabelAll2,LabelVesselAll)  
    accuracy2,specificity2,sensitivity2 = AVclassifiationMetrics(PredAll2,PredAll1,VesselPredAll,LabelAll2,LabelAll1,LabelVesselAll)      
...
#    print('Enlarged shape:', Img_enlarged.shape)
    ...
    Net = ResUnet_illum_tran_ds_add_conv3(resnet='resnet18',  num_classes= n_classes)
